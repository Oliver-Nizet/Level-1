...
public class SimonSays extends KeyAdapter {
	...
	private void makeAlbum() {
		...
		images.put(new Integer(KeyEvent.VK_UP), "keyF.png");
		images.put(new Integer(KeyEvent.VK_UP), "keyN.png");
		images.put(new Integer(KeyEvent.VK_UP), "keyL.png");
		images.put(new Integer(KeyEvent.VK_UP), "keyO.png");
	...
	private Component getNextRandomImage() {
		String file = null;
		while (file == null) {
			this.imageIndex = new Random().nextInt(images.size()) + 38;// + 37;
